        ...
        return
                http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                        .authorizeExchange((auth) -> auth
                                .pathMatchers("/tasktracker/account/**").permitAll()
                                .pathMatchers("/tasktracker/users/**").hasAnyAuthority("ROLE_USER", "ROLE_MANAGER")
                                .pathMatchers("/tasktracker/tasks/**").hasAnyAuthority("ROLE_USER", "ROLE_MANAGER")
